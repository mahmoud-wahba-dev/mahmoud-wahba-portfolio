...
const experiences = [
  {
    ...
    description: "Leading front-end development initiatives and implementing modern web solutions.",
    responsibilities: [
  ...
  },
  {
    ...
    description: "Developed and maintained responsive web applications using modern frameworks.",
    responsibilities: [
  ...
  },
  {
    ...
    description: "Created user interfaces and implemented front-end functionality for various projects.",
    responsibilities: [
